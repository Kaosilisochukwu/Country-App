...
const Details = ({country, countries}) => {
    ...
    useEffect(() => {
       ...
       if(country.borders){
        ...
        setBorderCountries(countries.filter(count => borders.includes(count.alpha3Code)))
       }
   ...
   console.log(lang)
   const {name, flag, nativeName, population, region, subregion, topLevelDomain, capital} = value;
        ...
        <div className = "details">
            ...
            <div className="details-main">
                <div className="details-image">
                    <img src={flag} alt={`${name} flag`} style={{width:"100%", height: "100%"}} />
                </div>
                <div className="details-info">
                    ...
                    <div className="detailsContainer">
                        ...
                        <div>
                            ...
                            <p><b>Currencies: </b>{curr.length > 0 && curr.map((x , i) => {
                                if(i === curr.length - 1){
                                    return <span>{x.name}</span>
                                }
                                return <span>{x.name}, </span>
                            })}</p>
                            <p><b>Languages: </b>{languages.length > 0 && languages.map((language, i) => {
